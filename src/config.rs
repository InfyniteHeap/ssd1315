...
pub struct Ssd1315DisplayConfig {
    ...
    /// Bits detail: `0b**xx'xxxx`.
    ///
    /// Set MUX ratio from `0` to `N+1`.
    ///
    /// N = A\[5:0]: `0b00'1111` - `0b11'1111`. RESET = `0b11'1111`, or 64MUX.
    ///
    /// A\[7:6] can be arbitrary values, but it's better to keep it `0b00`.
    pub multiplex_ratio: u8,
    /// Bits detail: `0b**xx'xxxx`.
    ///
    /// Set vertical shift by COM from `0b0000'0000` to `0b0011'1111`. The value is reset to `0b0000'0000` after RESET.
    pub display_offset: u8,
    /// Bits detail: `0b01xx'xxxx`.
    ///
    /// Set display RAM display start line register from `0b00'0000` to `0b11'1111`.
    ///
    /// Display start line register is reset to `0b0100'0000` after RESET.
    pub display_start_line: u8,
    /// Bits detail: `0b1010'000x`.
    ///
    /// Set segment remap.
    pub segment_remap: SegmentRemap,
    /// Bits detail: `0b1100'x000`.
    ///
    /// Set COM output scan direction.
    pub com_output_scan_direction: ComOutputScanDirection,
    /// Bits detail: `0b00xx'0010`.
    ///
    ...
    ///
    /// A\[7:0] valid range: `0b0000'0001`-`0b1111'1111`.
    pub contrast: u8,
    /// Bits detail: `0bxxxx'xxxx`.
    ///
...
impl Default for Ssd1315DisplayConfig {
    fn default() -> Self {
        Self {
            ...
            segment_remap: Default::default(),
            com_output_scan_direction: Default::default(),
            com_pins_hardware_config: 0x12,
            contrast: 0x7f,
            precharge_period: 0x22,
            v_comh_select_level: 0x20,
            normal_or_inverse_display: Default::default(),
            charge_pump: Default::default(),
        }
    }
}
